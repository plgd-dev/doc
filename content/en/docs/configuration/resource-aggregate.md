...
| `clients.eventStore.defaultCommandTimeToLive` | string | Replaces time to live in certain commands. Set to 0s for indefinite storage. | `"0s"` |
| `clients.eventStore.occMaxRetry` | int | Limits the number of attempts to store an event. | `8` |
