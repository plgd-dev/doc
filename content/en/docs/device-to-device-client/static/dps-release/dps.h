 ...
 */
DPS_EXPORT
size_t plgd_dps_get_device(plgd_dps_context_t *ctx) DPS_NONNULL();
 ...
 */
DPS_EXPORT
bool plgd_dps_get_skip_verify(plgd_dps_context_t *ctx) DPS_NONNULL();
 ...
 */
DPS_EXPORT
bool plgd_dps_has_forced_reprovision(plgd_dps_context_t *ctx) DPS_NONNULL();
